...
Процедура Главная()
	...
	// !! см. подробнее здесь: https://geniy1s.ru/programmnoe-dobavlenie-polzovatelej-v-bazy-na-bsp/
...
//	С.ПользовательОС = Неопределено;
	...
	С.ПользовательОС = "\\SVD\107";
	С.ЗапрещеноИзменятьПароль = ложь;
	С.ПоказыватьВСпискеВыбора = ложь;
	С.Профили = "Бухгалтер, Главный бухгалтер, Добавление и изменение дат запрета изменения";
	//С.Профили = "Бухгалтер";
